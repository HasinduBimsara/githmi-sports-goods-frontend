...
const baseInputClassName =
  "w-full h-[50px] rounded-xl border border-white bg-[#f0f4f9] px-4 text-center text-gray-900 placeholder-gray-500 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[#4f46e5]";
    ...
    <div className="w-full min-h-screen bg-[url('/login-bg.jpg')] bg-cover bg-center bg-no-repeat">
      <div className="min-h-screen bg-white/10">
        <div className="mx-auto flex min-h-screen w-full max-w-[1600px] px-4 py-10 sm:px-6 lg:px-8">
          ...
          >
            <div className="flex min-h-[680px] w-full max-w-md flex-col justify-center rounded-3xl border border-white/40 bg-white/20 p-8 shadow-2xl backdrop-blur-xl sm:p-10">
              ...
              <p className="mb-8 text-center text-sm font-medium text-gray-800 sm:text-base">
                {subtitle}
              </p>
              ...
              {footer && (
                <div className="mt-8 text-center text-sm font-medium text-gray-900 sm:text-base">
                  {footer}
                </div>
              )}
            </div>
...
export function AuthDivider({ label = "Or" }) {
  return (
    <div className="my-2 flex items-center">
      ...
      <span className="px-4 text-xs font-bold uppercase text-gray-800">
        {label}
      </span>
      <div className="flex-1 border-t border-gray-400"></div>
    </div>
